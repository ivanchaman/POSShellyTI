...
{
	public class MedicalClinicDiagnosticsInputType : InputObjectGraphType<Diagnostics>
	{

		public MedicalClinicDiagnosticsInputType()
		{

			Name = "MedicalClinicDiagnosticsInputType";
			#region Fields
