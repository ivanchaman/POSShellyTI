...
namespace Shelly.Abstractions.TwoFactor.Providers.Rng
{
    /// <summary>
    ...
    public class HashRngProvider : IRngProvider
    {
        ...
        public HashRngProvider(HashAlgorithm algorithm = null)
        {
            _algorithm = algorithm ?? HashAlgorithm.Create("HMACSHA256");
        }
