...
namespace Shelly.Abstractions.Helpers
{
     public static class ExtensionStrings
     {
          ...
          public static string GetNewIdForMongo()
          {
               return ObjectId.GenerateNewId(DateTime.Now.ToUniversalTime()).ToString();
          }
          ...
          public static bool ToBoolean2(this string inputString)
          {
          ...
          public static string[] Split(string value, string regexPattern)
          {
               return Split(value, regexPattern, RegexOptions.None);
          }
          ...
          /// <param name = "options">The regular expression options.</param>
          /// <returns>The splitted string array</returns>
          public static string[] Split(string value, string regexPattern, RegexOptions options)
          {
          ...
          /// <param name="dataToMatch">The data to match.</param>
          ...
          public static int Ocurre(this string text, char pcCaracterBuscado)
          {
               //Sirve para saber cuantas veces se encuentra una cadena dentro de otra
               int liContador;
               int liOcurrencia;
               char[] lcCadenaEnCaracteres;
               liOcurrencia = 0;
               if (String.IsNullOrEmpty(text))
                    return liOcurrencia;
               lcCadenaEnCaracteres = text.ToCharArray();
               for (liContador = 0; liContador <= lcCadenaEnCaracteres.Length - 1; liContador++)
               {
                    if (lcCadenaEnCaracteres[liContador] == pcCaracterBuscado)
                    {
                         liOcurrencia += 1;
                    }
               }
          ...
          public static int ValidateFolioIncapacity(this string text)
          {
               if (String.IsNullOrEmpty(text))
                    return -1;
               Regex patron = new Regex("[A-Za-z]{2}[0-9]{6}");
               text = text.Trim();
               if (text.Length < 8 || text.Length > 8)
                    return -1;
               if (patron.IsMatch(text))
                    return 0;
               return 2;
          }
          public static string DecodeString(string input)
          {
               ...
               inputstring.Replace("%41", "A");
               inputstring.Replace("%42", "B");
               inputstring.Replace("%43", "C");
               inputstring.Replace("%44", "D");
               inputstring.Replace("%61", "a");
               inputstring.Replace("%62", "b");
               inputstring.Replace("%63", "c");
               inputstring.Replace("%64", "d");
               inputstring.Replace("%30", "0");
               inputstring.Replace("%31", "1");
               inputstring.Replace("%32", "2");
               inputstring.Replace("%33", "3");
               inputstring.Replace("%20", " ");
               inputstring.Replace("%21", "!");
               inputstring.Replace("%22", "\"");
               inputstring.Replace("%23", "#");
               inputstring.Replace("%24", "$");
               inputstring.Replace("%25", "%");
               inputstring.Replace("%26", "&");
               inputstring.Replace("%27", "'");
               inputstring.Replace("%28", "(");
               inputstring.Replace("%29", ")");
               inputstring.Replace("%2A", "*");
               inputstring.Replace("%2B", "+");
               inputstring.Replace("%2C", ",");
               inputstring.Replace("%2D", "-");
               inputstring.Replace("%2E", ".");
               inputstring.Replace("%2F", "/");
               inputstring.Replace("%3A", ":");
               inputstring.Replace("%3B", ";");
               inputstring.Replace("%3C", "<");
               inputstring.Replace("%3D", "=");
               inputstring.Replace("%3E", ">");
               inputstring.Replace("%3F", "?");
               inputstring.Replace("%40", "@");
               inputstring.Replace("%5B", "[");
               inputstring.Replace("%5C", "\\");
               inputstring.Replace("%5D", "]");
               inputstring.Replace("%5E", "^");
               inputstring.Replace("%5F", "_");
               inputstring.Replace("%60", "`");
               inputstring.Replace("%7B", "{");
               inputstring.Replace("%7C", "|");
               inputstring.Replace("%7D", "}");
               inputstring.Replace("%7E", "~");
          ...
          public static void EncodeStrings()
          {
               ...
               Dictionary<string, Func<string, string>> columnDetails =
                   ...
                   {
                        { "Unencoded", (unencodedString => unencodedString) },
                        {
                             "UrlEncoded",
          ...
          public static string TrimIsNotNUll(this string value)
          {
               if (value == null)
                    return value;
               return value.Trim();
          ...
          public static string Replace(string str, string psOldChar, string psNewChar)
          {
               if (string.IsNullOrEmpty(psNewChar))
                    psNewChar = "";
               if (string.IsNullOrEmpty(psOldChar))
                    return str;
               if (string.IsNullOrEmpty(str))
                    return "";
               return str.Replace(psOldChar, psNewChar);
          }
          ...
          public static string SubString(this string value, int startindex, int inputlength)
          {
               int length;
               if (value.Length < (inputlength + startindex))
               {
                    length = value.Length - startindex;
                    return value.Substring(startindex, length);
               }
               return value.Substring(startindex, inputlength);
          }
          ...
          public static string Str(object poCadena)
          {
               return Convert.ToString(poCadena);
          }
