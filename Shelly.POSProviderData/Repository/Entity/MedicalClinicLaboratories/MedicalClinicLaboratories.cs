...
namespace Shelly.POSProviderData.Repository.Entity
{
	...
	/// Class Laboratories 
	/// </summary>
	public partial class Laboratories:StaticEntity
	{
		#region Contructor
		/// <summary>
		///  Initializes a new instance of the <see cref="Laboratories"/> class..
		/// </summary>
		public Laboratories():base()
		{
			Table = "Laboratories";
			Owner= "MedicalClinic";
		...
		public Laboratories(IBaseSystem IBaseSystem):base (IBaseSystem)
		{
			Table = "Laboratories";
			Owner= "MedicalClinic";
			LoadColumnProperties();
		...
		#region Funciones
		/// <summary>
		/// Load row of the Laboratories.		/// </summary>
