...
namespace Shelly.ProviderData.Repository.Entity
{
	...
	/// </summary>
	[Serializable]
	public partial class UsersDeletes : StaticEntity
	{
		#region Contructor
		/// <summary>
		///  Initializes a new instance of the <see cref="UsersDeletes"/> class..
		/// </summary>
		public UsersDeletes() : base()
		{
			Table = "Deletes";
			Owner = "Users";
		...
		public UsersDeletes(IBaseSystem IBaseSystem) : base(IBaseSystem)
		{
			Table = "Deletes";
			Owner = "Users";
			LoadColumnProperties();
		...
		#region Funciones
		/// <summary>
		/// Load row of the UsersDeletes.		/// </summary>
