...
namespace Shelly.Abstractions.Helpers
{
     public class Password
     {
          ...
          public Password(PasswordSettings settings)
          {
               Settings = settings;
          ...
          public Password IncludeNumeric()
          {
               Settings = Settings.AddNumeric();
               return this;
          }

          public Password IncludeSpecial()
          {
               Settings = Settings.AddSpecial();
               return this;
          }

          public Password IncludeSpecial(string specialCharactersToInclude)
          {
               Settings = Settings.AddSpecial(specialCharactersToInclude);
               return this;
          }

          public Password LengthRequired(int passwordLength)
          {
          ...
          private static bool PasswordIsValid(PasswordSettings settings, string password)
          {
